...
export function DrinkMeSection({
  isUploading,
  setIsUploading,
  onUploadSuccess,
  onUploadError,
    ...
    <div className="flex flex-col items-center justify-center p-4">
      {isUploading ? (
        <div className="flex flex-col items-center justify-center text-center py-20">
          ...
          <h3 className="font-serif text-xl text-amber-500 font-bold mb-2">
            Brewing New Scroll
          </h3>
          <p className="text-xs text-purple-200/60 font-sans max-w-sm leading-relaxed">
            Analyzing screenshot visual layouts, transcribing dense academic
            glyphs, and preparing the golden hour custom audio podcast. Please
            wait...
          </p>
        </div>
      ) : (
        <div className="w-full max-w-lg flex flex-col items-center">
          <div className="text-center mb-6">
            <h2 className="font-serif text-2xl text-amber-500 font-bold mb-2">
              Curiouser and Curiouser!
            </h2>
            <p className="text-xs text-purple-200/70 max-w-md mx-auto leading-relaxed">
              Adult students returning to college often face frighteningly dense
              textbooks. Pour a textbook screenshot below to easily read,
              listen, and dissect scholarly prose.
            </p>
          </div>
          <DrinkMeUpload
