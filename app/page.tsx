                      ...
                      {activeDoc.explanation ? (
                        <div className="flex-1 flex flex-col overflow-hidden">
                          ...
                          <div className="flex-1 overflow-y-auto pr-2 space-y-4 mb-4">
                            ...
                            <div className="text-xs sm:text-sm leading-relaxed text-purple-100/90 space-y-3 font-medium">
                        ...
                        /* Empty state: Consult Button */
                        <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
                          <div className="w-16 h-16 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center shadow-lg animate-bounce mb-4">
                            <Plus className="w-8 h-8 text-emerald-500" />
                          </div>
                          <h3 className="font-serif text-lg text-amber-500 font-bold mb-1">
                            Consult the Caterpillar
                          </h3>
                          <p className="text-xs text-purple-200/60 max-w-xs font-sans leading-relaxed mb-6">
                            This academic text contains intimidating concepts. Speak with the Caterpillar to filter jargon into plain, clear, real-world analogies.
                          </p>
                          <button
                            onClick={handleConsultCaterpillar}
                            className="w-full max-w-xs py-3 px-5 bg-radial from-emerald-700 to-emerald-900 border border-emerald-500 text-amber-300 font-serif font-bold text-xs uppercase tracking-widest rounded-xl hover:from-emerald-600 hover:to-emerald-800 hover:text-white transform active:scale-97 shadow-xl transition-all cursor-pointer"
                          >
                            Consult the Caterpillar
                          </button>
                        </div>
